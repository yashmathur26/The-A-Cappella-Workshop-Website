...
export const STAFF_BIOS = [
  ...
  },
  {
    ...
    title: "Lexington Co-President",
    bio: "Shuntavi is a freshman at Tufts University. At LHS, she sang in Chamber Singers and Concert Choir, participated in Singing Valentines, and co-led Noteworthy, one of LHS's co-ed a cappella groups. She has attended the A Cappella Academy in LA and taught for two years at the 'Shop before becoming a co-president. She loves getting to bring a cappella to each new generation of singers!",
